                            ...
                            <tbody>
                                {orders?.data.map((log, k) => (
                                    <tr key={log.order_info} className={(k + 1) % 2 === 0 ? 'bg-gray-100' : ''}>
                                        ...
                                        <td className="table-info border-t-0 px-6 align-center border-l-0 border-r-0 text-sm p-4" dangerouslySetInnerHTML={{ __html: log.order_info }} />
                                        <td className="table-info border-t-0 px-6 align-center border-l-0 border-r-0 text-sm p-4" dangerouslySetInnerHTML={{ __html: log.order_referrer }} />
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm xl:whitespace-nowrap p-4 ">{log.order_date}</td>
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm xl:whitespace-nowrap p-4" dangerouslySetInnerHTML={{ __html: log.order_total }} />
                                    </tr>
                                ))}
                            </tbody>
                        </table>
