				...
				<div className='md:basis-4/5'>
					<div className='bg-white p-6 rounded-xl border border-gray-200 mb-4'>
						<ToggleField
							...
							description='Check to disable showing referral links on product single pages.'
						/>
						<TextArea
							label='Description Text'
				...
				<div className='md:basis-4/5'>
					<div className='bg-white p-6 rounded-xl border border-gray-200 mb-4'>
						<InputText
							...
							description=''
							error={errors.gens_raf_twitter_via?.message}
							register={register}
						...
						<ToggleField
							...
							description='Mobile share is always available on mobile.'
						/>
