            ...
            <div className="flex flex-col md:flex-row mb-8">
                ...
                <div className="md:basis-4/5">
                    <div className="bg-white p-6 rounded-xl border border-gray-200 mb-4">
                        ...
                        />
                        <ToggleField register={register} name="gens_raf_use_woo_mail" label="WooCommerce Template" description="Check this to use woo default email template." />
                    </div>
                </div>
            </div>
            <div className="flex flex-col md:flex-row mb-8">
                ...
                <div className="md:basis-4/5">
                    <div className="bg-white p-6 rounded-xl border border-gray-200 mb-4">
                        <ToggleField register={register} name="gens_raf_email_hide" label="Hide share via email option" description="Checking this will remove share via email option." />
                        <InputText
                            label="Email Subject"
