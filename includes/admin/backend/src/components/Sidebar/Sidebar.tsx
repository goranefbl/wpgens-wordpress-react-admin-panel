        ...
        <div className={`${sidebarVisible ? 'block absolute z-10' : 'hidden'} lg:block w-72 min-h-screen bg-[#344054] text-white border-r-white border-r`}>
            <div className="mt-6 h-full overflow-y-auto w-72">
                ...
                <ul className="px-5 mb-4">
                    <MenuItem page={page} setPage={setPage} title={Pages.Orders} Image={AnalyticsSVG} />
                    <MenuItem page={page} setPage={setPage} title={Pages.Advocates} Image={UserSVG} />
                    <MenuItem page={page} setPage={setPage} title={Pages.Settings} Image={SettingsSVG} submenu={emailSubmenu} />
                    <MenuItem page={page} setPage={setPage} title={Pages.Licence} Image={InvoiceSVG} />
                    <MenuItem page={page} setPage={setPage} title={Pages.Events} Image={DashboardSVG} />
                    <MenuItem page={page} setPage={setPage} title={Pages.WPGensPlugins} Image={LinkSVG} link="https://wpgens.com/#plugins" />
                </ul>
                <Footer />
            </div>
        </div>
