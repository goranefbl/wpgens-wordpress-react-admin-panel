    ...
    return (
        <div className="absolute top-0 right-0 left-0 bottom-0 z-10">
            <div className="flex -ml-5 -mt-5 text-[#6b7280]">
                ...
                {/* <div className={`inline-flex justify-center items-center z-50 fixed h-10 w-full bottom-0 left-0 text-center bg-orange-400 text-white leading-10`}>
                <span>
                    Add Your Licence key here:{' '}
                    <a href="https://loyalgenie.helpscoutdocs.com/article/114-test-mode" className="underline" target="_blank" rel="noreferrer">
                        Learn more
                    </a>
                </span>
            </div> */}
